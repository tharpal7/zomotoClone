...
const ExploreCard = ({ restaurant }) => {
   ...
   const converImg = restaurant?.info?.image?.url;
   ...
   return (
      <div className="explore-card cur-po">
         <div className="explore-card-cover  ">
            <img src={converImg} alt={name} className="exlpore-card-image" />
            <div className="delivery-time">{deliveryTime}</div>

            {proOff && <div className="pro-off">{proOff}</div>}
            {goldOff && <div className="gold-off absolute-center">{goldOff}</div>}
            {discount && <div className="discount absolute-center">{discount}</div>}
            <div className=" max-width res-row">


               <div className="name-rating">
                  <div className="res-name">{name}</div>
                  {rating && (
                     <div className="res-rating absolute-center">{rating} <i className="fa-regular fa-star absolute-center"></i> </div>)}
               </div>
